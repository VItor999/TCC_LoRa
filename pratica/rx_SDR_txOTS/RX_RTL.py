...
class RX_RTL(gr.top_block):
    ...
    def __init__(self, bw=125000, center_freq=915000000, cr=1, has_crc=1, impl_head=0, out_file='/home/vcarv/TCC/practice/rx_SDR_tx_SDR/pqp.dat', samp_rate=500000, sf=9, soft_decoding=1):
        ...
        self.rtlsdr_source_0.set_sample_rate(2*samp_rate)
    ...
    def set_samp_rate(self, samp_rate):
        self.samp_rate = samp_rate
        self.rtlsdr_source_0.set_sample_rate(2*self.samp_rate)
...
def main(top_block_cls=RX_RTL, options=None):
    ...
    tb = top_block_cls(bw=options.bw, center_freq=options.center_freq, cr=options.cr, has_crc=options.has_crc, impl_head=options.impl_head, out_file=options.out_file, samp_rate=options.samp_rate, sf=options.sf, soft_decoding=options.soft_decoding)
