...
class TX_SDR_LIME(gr.top_block):
    ...
    def __init__(self, bw=125000, center_freq=915000000, cr=1, has_crc=1, impl_head=0, in_file='/home/vcarv/TCC/simulation/tx_data/tx_text.txt', samp_rate=250000, sf=9, soft_decoding=1):
...
def argument_parser():
    ...
    parser.add_argument(
        "--in-file", dest="in_file", type=str, default='/home/vcarv/TCC/simulation/tx_data/tx_text.txt',
        help="Set /home/vcarv/TCC/simulation/tx_data/tx_text.txt [default=%(default)r]")
    parser.add_argument(
